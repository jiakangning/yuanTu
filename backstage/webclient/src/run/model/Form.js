...
class FormColumn {
  ...
  constructor(options) {
    ...
    this.default = _.get(options, "default")
  }
}
...
export default class Form extends Base {
  ...
  getDefault() {
    let column = this.columns.reduce((results, item) => {
      if (item.default !== undefined) {
        let val = typeof item.default === "function" ? item.default(this) : item.default
        results[item.field] = val
      }
      return results
    }, {})
    let form = this.getConfig("default")
    form = typeof form === "function" ? form(this) : form
    return Object.assign({}, column, form)
  }
