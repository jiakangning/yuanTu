<template>
  <div class="columnTime">
    <h3 class="columnTime-title">年度</h3>
    <div class="columnTime-year">
      <el-radio
    ...
    <h3 class="columnTime-title">月度</h3>
    <div class="columnTime-month">
      <el-slider
        v-model="curMonth"
        show-stops
    ...
    <h3 class="columnTime-title">日期</h3>
    <div class="columnTime-date">
      <el-date-picker
        class="columnTime-date-main"
    ...
    <h3 class="columnTime-title">快捷</h3>
    <div class="columnTime-shortcut">
      <el-tag
        class="columnTime-shortcut-tag"
