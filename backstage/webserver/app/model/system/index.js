...
Department.belongsToMany(Contact, { through: 'system_member_dept_permission', as: 'Contacts', foreignKey: 'depot_id', constraints: false })
Contact.belongsToMany(Department, { through: 'system_member_dept_permission', as: 'Departments', foreignKey: 'contact_id', constraints: false })
Department.belongsTo(Contact, { foreignKey: 'supervisor', as: 'Supervisor', onDelete: 'SET NULL' })
